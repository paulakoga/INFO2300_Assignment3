...
export class ConcertListDialogComponent implements OnInit {
  ...
  timeStartCtrl: FormControl = new FormControl(null, Validators.pattern('[0-2][0-9]:[0-5][0-9]'))
  timeEndCtrl: FormControl = new FormControl(null, Validators.pattern('[0-2][0-9]:[0-5][0-9]'))
